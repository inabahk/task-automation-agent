...
🧪 Example Execution
Input: "Search for AI trends and save summary"
...
📌 What It Does
User submits a task in natural language
Agent generates a plan — breaks it into steps mapped to tools
Human reviews and approves — toggle steps on/off before execution
Agent executes approved steps — runs tools and returns results
